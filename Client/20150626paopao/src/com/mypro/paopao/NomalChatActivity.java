...
public class NomalChatActivity extends Activity {
	...
	private CharSequence judgeImage(String s){
		SpannableString spannableString = FaceConversionUtil.getInstace().getExpressionString(getApplicationContext(), s);
...
//				holder.datail.setText(data.getChatItem());
				holder.datail.setText(judgeImage(data.getChatItem()));
				if (you != null)
